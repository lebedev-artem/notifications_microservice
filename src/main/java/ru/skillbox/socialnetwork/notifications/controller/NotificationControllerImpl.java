...
public class NotificationControllerImpl implements NotificationController {
    ...
    public NotificationControllerImpl(ObjectMapper objectMapper, HttpServletRequest request) {
	...
	public ResponseEntity<NotificationCountDto> getCount() {
		...
		return new ResponseEntity<NotificationCountDto>(HttpStatus.NOT_IMPLEMENTED);
	}
