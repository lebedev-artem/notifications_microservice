...
```
cd existing_repo
git remote add origin https://gitlab.skillbox.ru/javapro_team39/notifications_microservice.git
git branch -M master
...
- [ ] [Set up project integrations](https://gitlab.skillbox.ru/javapro_team39/notifications_microservice/-/settings/integrations)
